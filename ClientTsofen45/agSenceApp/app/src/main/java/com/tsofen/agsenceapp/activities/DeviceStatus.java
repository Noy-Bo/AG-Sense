...
public class DeviceStatus extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Devices devices1 = new Devices(0,1,1,"DeviceName1","GPS",date,date1,true);
        Devices devices2 = new Devices(0,1,1,"DeviceName2","Bank",date,date1,true);
        Devices devices3 = new Devices(0,1,1,"DeviceName3","Tank",date,date1,true);
        Devices devices4 = new Devices(0,1,1,"DeviceName4","Tank",date,date1,true);
        Devices devices5 = new Devices(0,1,1,"DeviceName5","GPS",date,date1,true);
        Devices devices6 = new Devices(0,1,1,"DeviceName6","GPS",date,date1,true);
        Devices devices7 = new Devices(0,1,1,"DeviceName7","Bank",date,date1,true);
        Devices devices8 = new Devices(0,1,1,"DeviceName8","Bank",date,date1,true);
        Devices devices9 = new Devices(0,1,1,"DeviceName9","Tank",date,date1,true);
        Devices devices10 = new Devices(0,1,1,"DeviceName10","GPS",date,date1,true);
        Devices devices11 = new Devices(0,1,1,"DeviceName11","Tank",date,date1,true);
        Devices devices12 = new Devices(0,1,1,"DeviceName12","Bank",date,date1,true);
        Devices devices13 = new Devices(0,1,1,"DeviceName13","GPS",date,date1,true);
        Devices devices14 = new Devices(0,1,1,"DeviceName14","Tank",date,date1,true);
        Devices devices15 = new Devices(0,1,1,"DeviceName15","GPS",date,date1,true);
