...
public class DeviceSettingsAdapter extends ArrayAdapter<Devices> implements Serializable {

        LayoutInflater inflater;

        public DeviceSettingsAdapter(Context context, int resource, Devices[] devices) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            @SuppressLint("ViewHolder") View layout = this.inflater.inflate(R.layout.activity_device_setting, null);
