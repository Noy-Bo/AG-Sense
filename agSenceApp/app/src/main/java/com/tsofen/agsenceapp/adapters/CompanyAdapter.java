...
import com.tsofen.agsenceapp.activities.AccountStatusFilter;
import com.tsofen.agsenceapp.activities.AdminDashboardActivity;
import com.tsofen.agsenceapp.activities.CompanyStatus;
...
public class CompanyAdapter<A extends User> extends ArrayAdapter<Account> implements Serializable {
    LayoutInflater inflater;
    ArrayList<Account> accounts;

    public CompanyAdapter(Context context, List<Account> users) {
